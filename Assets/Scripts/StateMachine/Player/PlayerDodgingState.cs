...
namespace ThirdPersonCombat.StateMachine.Player
{
    ...
    {
        private readonly int DodgingBlendTree = Animator.StringToHash("DodgeBlendTree");
        ...
        public PlayerDodgingState(PlayerStateMachine newStateMachine, Vector3 dodgingDirectionInput) : base(newStateMachine)
        {
        ...
        public override void Enter()
        {
            ...
            stateMachine.Animator.CrossFadeInFixedTime(DodgingBlendTree, AnimatorDampTime);
